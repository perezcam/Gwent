...
{ 
    ...
    {
        //Humanity Deck
        public static Card Armin = new Card("Armin Arlet","Humanity",  "Carta de Héroe: Estratega capaz de cambiar el rumbo de la batalla con su agudo intelecto, unificando las fuerzas de todos los guerreros para vencer",8, 1, null, Functions.AvaragedPower, new List<int>{3} , 0);
        public static Card AtaqueNocturno = new Card("Ataque Nocturno","Humanity", "Carta Clima: Ataque sorpresa nocturno que debilita la primera linea enemiga, reduciendo el poder de las cartas con capacidad de ataque 4 o inferior a 0.",0, 2, null, Functions.W_ReducePowerOfWeakCards, new List<int>{8}, 1);
        ...
        public static Card Connie = new Card("Connie Springer","Humanity", "Carta de Unidad: Rápido y ágil, excepcional en ataques veloces.",4, 4, null, Functions.DelPowerfullCard, new List<int>{1}, 0);
        ...
        public static Card Gabi = new Card("Gabi Braun","Humanity","Carta de Unidad: Joven e imprudente, capaz de daños inesperados y dramáticos. Es un buen recurso que aumentara el poder de los que luchan a su lado", 5, 10, null, Functions.IncreasePowerRow, new List<int>{1}, 0);
        ...
        public static Card Hannes = new Card("Hannes","Humanity", "Carta de Unidad: Soldado veterano, proporciona una defensa sólida contra los ataques.Puede inhabilitar un clima",4, 12, null, Functions.DelPowerfullCard, new List<int>{5}, 0);
        ...
        public static Card Jean = new Card("Jean Kirstein","Humanity", "Carta de Unidad: Luchador adaptable, eficaz en múltiples escenarios de combate.",6, 14, null, Functions.StealCard, new List<int>{5}, 0);
        ...
        public static Card Petra = new Card("Petra Ral","Humanity", "Carta de Unidad: Apoya a sus aliados con habilidades que mejoran sus capacidades.Te permite obtener mas apoyo al incrementa 1 carta a tu mano",4, 20, null, Functions.StealCard, new List<int>{3}, 0);
        ...
        public static Card Sasha = new Card("Sasha Blouse","Humanity", "Carta de Unidad: Francotiradora, puede apuntar a unidades clave enemigas desde la distancia.Podra eliminar a el mas poderoso enemigo desde lejos",6, 22, null, Functions.DelPowerfullCard, new List<int>{3}, 0);
        ...
        public static Card CalorSofocante = new Card("Calor Sofocante","Titans","Carta de Clima: Aumenta la temperatura del campo de batalla, debilitando a las unidades con poder menor o igual que 4 que estan activas en su fila.", 0, 45, null, Functions.W_ReducePowerOfWeakCards,new List<int>{7}, 1);
        ...
        public static Card LLuviadeRocas = new Card("Lluvia de Rocas","Titans","Carta de Clima: Lanza rocas gigantes desde el cielo, dañando a todas las unidades , propias y enemigas de su fil. Evita el uso de cartas de incremeto.", 0, 50, null, Functions.W_ResetCardValues, new List<int>{9}, 1);
        public static Card SuenodeFundador = new Card("Sueño de Fundador","Titans","Carta Clima: Un poderoso efecto que altera el estado del juego, reconfigurando el campo de batalla, al disminuir el poder de cada carta debil colocada en ese tipo de fila que le corresponde a cero.", 0, 51, null, Functions.W_ReducePowerOfWeakCards, new List<int>{8}, 1);

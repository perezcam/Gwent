...
{ 
    public class LogicGameManager
    {
        ...
        public static Card EstrategiaLevi = new Card("Estrategia de Levi", 7, 8, null, Functions.CleanRow, 1, 0);
        ...
        public static Card Hange = new Card("Hange Zoë", 5, 11, null, Functions.NullFunction, 0, 0);
        ...
        public static Card TitanFundador = new Card("Titán Fundador", 9, 27, null, Functions.IncreasePowerRow, 0, 0);
        public static Card TitanAcorazado = new Card("Titán Acorazado", 8, 28, null, Functions.IncreasePowerRow, 1, 0);
        public static Card TitanHembra = new Card("Titán Hembra", 8, 29, null, Functions.IncreasePowerRow, 2, 0);
        public static Card TitanColosal = new Card("Titán Colosal", 10, 30, null, Functions.IncreasePowerRow, 3, 0);
        public static Card TitanSantaClaus = new Card("Titán Santa Claus", 6, 31, null, Functions.IncreasePowerRow, 5, 0);
        public static Card TitanDentada = new Card("Titán Dentada", 5, 32, null, Functions.IncreasePowerRow, 1, 0);
        public static Card TitanGloton = new Card("Titán Glotón", 4, 33, null, Functions.IncreasePowerRow, 1, 0);
        public static Card TitanObervador = new Card("Titán Observador", 3, 34, null, Functions.IncreasePowerRow, 2, 0);
        public static Card TitanSonriente = new Card("Titán Sonriente", 5, 35, null, Functions.IncreasePowerRow, 1, 0);
        public static Card TitanSaltarin = new Card("Titán Saltarín", 4, 36, null, Functions.IncreasePowerRow, 2, 0);
        public static Card TitanAgraciado = new Card("Titán Agraciado", 4, 37, null, Functions.IncreasePowerRow, 2, 0);
        public static Card TitanCarguero = new Card("Titán Carguero", 6, 38, null, Functions.IncreasePowerRow, 3, 0);
        public static Card TitanMandibula = new Card("Titán Mandíbula", 6, 39, null, Functions.IncreasePowerRow, 1, 0);
        public static Card TitanMartillodeGuerra = new Card("Titán Martillo de Guerra", 7, 40, null, Functions.IncreasePowerRow, 3, 0);
        public static Card TitanFalco = new Card("Titán Falco", 4, 41, null, Functions.IncreasePowerRow, 1, 0);
        public static Card TitanDesCarado = new Card("Titán Descarado", 4, 42, null, Functions.IncreasePowerRow, 1, 0);
        public static Card TitanParlante = new Card("Titán Parlante", 3, 43, null, Functions.IncreasePowerRow, 2, 0);
        public static Card TitanTatin = new Card("Titán Tatin", 2, 44, null, Functions.IncreasePowerRow, 1, 0);
        public static Card CalorSofocante = new Card("Calor Sofocante", 2, 45, null, Functions.IncreasePowerRow, 5, 0);
        public static Card Caminos = new Card("Caminos", 2, 46, null, Functions.IncreasePowerRow, 5, 0);
        public static Card ElDespertar = new Card("El Despertar", 3, 47, null, Functions.IncreasePowerRow, 3, 0);
        public static Card SuerodeTitan = new Card("Suero de Titán", 2, 48, null, Functions.IncreasePowerRow, 0, 0);
        public static Card FuriaTitan = new Card("Furia de Titán", 3, 49, null, Functions.IncreasePowerRow, 1, 0);
        public static Card LLuviadeRocas = new Card("Lluvia de Rocas", 3, 50, null, Functions.IncreasePowerRow, 5, 0);
        public static Card SuenodeFundador = new Card("Sueño de Fundador", 3, 51, null, Functions.IncreasePowerRow, 0, 0);
        public static Card RugidodelTitanBestia = new Card("Rugido del Titán Bestia", 2, 52, null, Functions.IncreasePowerRow, 5, 0);
